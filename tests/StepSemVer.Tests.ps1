  ...
  Describe 'Step-SemanticVersion' {
    Context 'Major' {
      ...
      It 'Supports piping the version' {
        ([semver] '1.2.3') | Step-SemanticVersion -BumpType major | Should -Be 2.0.0
      }
    }
    Context 'Minor' {
      ...
      It 'Supports piping the version' {
        ([semver] '1.2.3') | Step-SemanticVersion -BumpType minor | Should -Be 1.3.0
      }
    }
    Context 'Patch' {
      ...
      It 'Supports piping the version' {
        ([semver] '1.2.3') | Step-SemanticVersion -BumpType patch | Should -Be 1.2.4
      }
    }
  }
}